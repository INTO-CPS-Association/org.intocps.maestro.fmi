...
function compileDarwin64
{
		...
		JAVA_HOME=`readlink -f third_party/jvm/darwin64/` cmake  \
						 -B$B \
						 -H$1 \
...
function compileWin32
{
		...
		JAVA_HOME=`readlink -f third_party/jvm/win32` cmake  \
						 -B$B \
						 -H$1 \
...
function compileWin64
{
		...
		JAVA_HOME=`readlink -f third_party/jvm/win64` cmake  \
						 -B$B \
						 -H$1 \
...
function compileLinux64
{
		...
		JAVA_HOME=`readlink -f third_party/jvm/linux64` cmake  \
						 -B$B \
						 -H$1 #\
...
function compileLinux32
{
		...
		CC="gcc -m32" CXX="g++ -m32" JAVA_HOME=`readlink -f third_party/jvm/linux64` cmake \
			-B$B \
			-H$1 \
...
#xcompile jnifmuapi/src/main/native

D=jnifmuapi/src/main/native
