...
class DirectoryFmu extends NativeFmu implements IFmu
{
			...
			throws XPathExpressionException, FmiInvalidNativeStateException
	{
		...
		if (System.getProperty("fmi.instantiate.with.empty.authority") != null
		...
		if (callback != null)
		{
			...
			{
				@Override
				public void log(String name, byte status, String category,
						String message)
				{
	...
	void synchronizedFree(FmuComponent comp)
