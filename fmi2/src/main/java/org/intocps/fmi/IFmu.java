...
public interface IFmu {
     ...
     * @param loggingOn true if logging should be enabled
     * @param callback  null or callback
     * @return the component
     * @throws XPathExpressionException       if lookup in model description fail
     * @throws FmiInvalidNativeStateException if the state invocation fail
     */
    public abstract IFmiComponent instantiate(String guid, String name, boolean visible, boolean loggingOn,
